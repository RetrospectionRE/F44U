...
class ResNetEncoder_SK(nn.Module):
    def __init__(self, base_channels=16):
        super().__init__()
        resnet = models.resnet34(weights=models.ResNet34_Weights.IMAGENET1K_V1)  # 替换为ResNet34
